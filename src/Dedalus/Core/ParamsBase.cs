...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("DEDALUS_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(DedalusClient).Name}/C# {GetPackageVersion()}";
