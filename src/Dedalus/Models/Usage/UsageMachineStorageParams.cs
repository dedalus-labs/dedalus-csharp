...
/// </summary>
public record class UsageMachineStorageParams : ParamsBase
{
    /// <summary>
    ...
    public UsageMachineStorageParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public UsageMachineStorageParams(UsageMachineStorageParams usageMachineStorageParams)
        : base(usageMachineStorageParams) { }
...
#pragma warning restore CS8618
    ...
    public static UsageMachineStorageParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(UsageMachineStorageParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/usage/machines/storage"
        )
        {
