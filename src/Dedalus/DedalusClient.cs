...
/// <inheritdoc/>
public sealed class DedalusClient : IDedalusClient
{
    ...
    {
        get { return this._options.XApiKey; }
        init { this._options.XApiKey = value; }
    }

    /// <inheritdoc/>
    public string? DedalusOrgID
    {
        get { return this._options.DedalusOrgID; }
        init { this._options.DedalusOrgID = value; }
    }

    readonly Lazy<IDedalusClientWithRawResponse> _withRawResponse;

    /// <inheritdoc/>
    public IDedalusClientWithRawResponse WithRawResponse
    {
        get { return _withRawResponse.Value; }
    }

    /// <inheritdoc/>
    public IDedalusClient WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
    ...
    {
        get { return _machines.Value; }
    }

    public void Dispose() => this.HttpClient.Dispose();

    public DedalusClient()
    {
        _options = new();
    ...
    public DedalusClient(ClientOptions options)
        : this()
    {
        _options = options;
    }
...
/// <inheritdoc/>
public sealed class DedalusClientWithRawResponse : IDedalusClientWithRawResponse
{
#if NET
    ...
    public IMachineServiceWithRawResponse Machines
    {
        get { return _machines.Value; }
    }
        ...
        where T : ParamsBase
    {
        ...
        while (true)
        {
            ...
            if (response != null && (++retries > maxRetries || !ShouldRetry(response)))
            {
                ...
                try
                {
                    throw DedalusExceptionFactory.CreateApiException(
                        response.StatusCode,
                ...
                {
                    throw new DedalusIOException("I/O Exception", e);
                }
                finally
                {
                    response.Dispose();
    ...
    {
        return e is IOException || e is DedalusIOException;
    }

    public void Dispose() => this.HttpClient.Dispose();

    public DedalusClientWithRawResponse()
    {
        _options = new();
    ...
    public DedalusClientWithRawResponse(ClientOptions options)
        : this()
    {
        _options = options;
    }
